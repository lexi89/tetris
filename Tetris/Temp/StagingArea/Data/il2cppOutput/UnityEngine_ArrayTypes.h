...
// UnityEngine.Transform[,]
struct TransformU5BU2CU5D_t3792884696  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Transform_t1659122786 * m_Items[1];
...
public:
	...
	inline Transform_t1659122786 * GetAt(il2cpp_array_size_t i, il2cpp_array_size_t j) const
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		return m_Items[index];
	}
	inline Transform_t1659122786 ** GetAddressAt(il2cpp_array_size_t i, il2cpp_array_size_t j)
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		return m_Items + index;
	}
	inline void SetAt(il2cpp_array_size_t i, il2cpp_array_size_t j, Transform_t1659122786 * value)
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
